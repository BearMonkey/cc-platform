...
public class AlipayTradePagePay {
    ...
    public static void main(String[] args) throws AlipayApiException {
        ...
        // 设置订单绝对超时时间
        model.setTimeExpire("2024-06-30 10:05:01");
        ...
        // 设置商户的原始订单号
        model.setMerchantOrderNo(System.currentTimeMillis() + "");
    ...
    private static AlipayConfig getAlipayConfig() {
        String privateKey  = AlipayConstants.PRIVATE_KEY;
        String alipayPublicKey = AlipayConstants.ALIPAY_PUBLIC_KEY;
